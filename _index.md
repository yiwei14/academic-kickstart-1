...
bio: I am interested in power analysis and financial statistics.
...
education:
  courses:
  - course: BSc Statistics and Economics
...
- icon: envelope
  icon_pack: fas
  link: '#contact'  # For a direct email link, use "yiwei14@ualberta.ca".
- icon: github
  icon_pack: fab
  link: https://github.com/Yiwei
